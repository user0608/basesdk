  ...
  return (
    <main className="min-h-screen bg-ui-bg text-ui-text">
      <div className="flex min-h-screen flex-col">
        <header className="border-b border-ui-border/35 bg-ui-panel shadow-sm">
        ...
        {isMobileMenuOpen && activeModule && (
          <div className="fixed inset-x-0 top-16 z-40 border-b border-ui-border/30 bg-ui-panel/95 p-2 shadow-lg backdrop-blur lg:hidden">
            <div className="grid gap-2">
              ...
              {activeMenu && (
                <nav className="flex gap-1 overflow-x-auto border-t border-ui-border/20 pt-2">
        ...
        <div className="grid min-h-0 flex-1 lg:grid-cols-[76px_190px_minmax(0,1fr)]">
          <aside className="hidden border-r border-ui-border/30 bg-ui-panel px-2 py-2 lg:block">
            {activeModule ? (
          ...
          <aside className="hidden border-r border-ui-border/30 bg-ui-panel px-2.5 py-2 lg:block">
            {activeMenu ? (
              <nav className="grid gap-1">
                {activeMenu.children.map((operation) => {
                  const isActive = location.pathname === operation.path;
          ...
          <section className="flex min-h-0 flex-col bg-ui-panel-muted">
            <div className="flex-1 px-3 py-3 lg:px-4 lg:py-4">{children}</div>
          </section>
        </div>
      </div>
    </main>
