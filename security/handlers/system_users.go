...
func SystemUsersListHandler(usecase *usecases.SystemUsersUsecase) httpapi.Route {
	return &httpapi.SystemHandler{Method: http.MethodGet, Path: "/api/v1/system/users", Handler: func(c echo.Context) error {
...
func SystemUserCreateHandler(usecase *usecases.SystemUsersUsecase) httpapi.Route {
	return &httpapi.SystemHandler{Method: http.MethodPost, Path: "/api/v1/system/users", Handler: func(c echo.Context) error {
...
func SystemUserFindHandler(usecase *usecases.SystemUsersUsecase) httpapi.Route {
	return &httpapi.SystemHandler{Method: http.MethodGet, Path: "/api/v1/system/users/:username", Handler: func(c echo.Context) error {
...
func SystemUserUpdateHandler(usecase *usecases.SystemUsersUsecase) httpapi.Route {
	return &httpapi.SystemHandler{Method: http.MethodPut, Path: "/api/v1/system/users/:username", Handler: func(c echo.Context) error {
...
func SystemUserPasswordHandler(usecase *usecases.SystemUsersUsecase) httpapi.Route {
	return &httpapi.SystemHandler{Method: http.MethodPatch, Path: "/api/v1/system/users/:username/password", Handler: func(c echo.Context) error {
...
func SystemUsersEnableHandler(usecase *usecases.SystemUsersUsecase) httpapi.Route {
	return &httpapi.SystemHandler{Method: http.MethodPatch, Path: "/api/v1/system/users/enable", Handler: func(c echo.Context) error {
...
func SystemUsersDisableHandler(usecase *usecases.SystemUsersUsecase) httpapi.Route {
	return &httpapi.SystemHandler{Method: http.MethodPatch, Path: "/api/v1/system/users/disable", Handler: func(c echo.Context) error {
		values, err := requestStrings(c)
		if err != nil {
			return answer.Err(c, err)
		}
...
func SystemUsersDeleteHandler(usecase *usecases.SystemUsersUsecase) httpapi.Route {
	return &httpapi.SystemHandler{Method: http.MethodDelete, Path: "/api/v1/system/users", Handler: func(c echo.Context) error {
		values, err := requestStrings(c)
		if err != nil {
			return answer.Err(c, err)
		}
